...
part of 'ccrJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CcrJsonFile _$CcrJsonFileFromJson(Map<String, dynamic> json) => CcrJsonFile()
  ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$CcrJsonFileToJson(CcrJsonFile instance) =>
    <String, dynamic>{
