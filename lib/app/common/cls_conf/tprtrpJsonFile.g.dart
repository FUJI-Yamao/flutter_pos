...
part of 'tprtrpJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TprtrpJsonFile _$TprtrpJsonFileFromJson(Map<String, dynamic> json) =>
    TprtrpJsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$TprtrpJsonFileToJson(TprtrpJsonFile instance) =>
    <String, dynamic>{
