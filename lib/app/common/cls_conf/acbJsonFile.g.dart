...
part of 'acbJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AcbJsonFile _$AcbJsonFileFromJson(Map<String, dynamic> json) => AcbJsonFile()
  ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$AcbJsonFileToJson(AcbJsonFile instance) =>
    <String, dynamic>{
