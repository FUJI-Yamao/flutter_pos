...
part of 'scan_2800i3_1JsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Scan_2800i3_1JsonFile _$Scan_2800i3_1JsonFileFromJson(
        Map<String, dynamic> json) =>
    Scan_2800i3_1JsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$Scan_2800i3_1JsonFileToJson(
        Scan_2800i3_1JsonFile instance) =>
    <String, dynamic>{
