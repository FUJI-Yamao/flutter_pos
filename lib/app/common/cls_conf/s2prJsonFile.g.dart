...
part of 's2prJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

S2prJsonFile _$S2prJsonFileFromJson(Map<String, dynamic> json) => S2prJsonFile()
  ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$S2prJsonFileToJson(S2prJsonFile instance) =>
    <String, dynamic>{
