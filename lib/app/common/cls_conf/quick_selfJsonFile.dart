...
part 'quick_selfJsonFile.g.dart';

@JsonSerializable(explicitToJson:true)
class Quick_selfJsonFile extends ConfigJsonFile {
  static final Quick_selfJsonFile _instance = Quick_selfJsonFile._internal();

  final String _confPath = "conf/";
  final String _fileName = "quick_self.json";

  Quick_selfJsonFile(){
    setPath(_confPath, _fileName);
  }
  Quick_selfJsonFile._internal();

  factory Quick_selfJsonFile.fromJson(Map<String, dynamic> json_T) =>
      _$Quick_selfJsonFileFromJson(json_T);

  Map<String, dynamic> toJson() => _$Quick_selfJsonFileToJson(this);

  String jsonFileToJson(){
    return jsonEncode(_$Quick_selfJsonFileToJson(this));
  }
