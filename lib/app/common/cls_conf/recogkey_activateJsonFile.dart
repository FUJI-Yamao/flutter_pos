...
part 'recogkey_activateJsonFile.g.dart';

@JsonSerializable(explicitToJson:true)
class Recogkey_activateJsonFile extends ConfigJsonFile {
  static final Recogkey_activateJsonFile _instance = Recogkey_activateJsonFile._internal();

  final String _confPath = "conf/";
  final String _fileName = "recogkey_activate.json";

  Recogkey_activateJsonFile(){
    setPath(_confPath, _fileName);
  }
  Recogkey_activateJsonFile._internal();

  factory Recogkey_activateJsonFile.fromJson(Map<String, dynamic> json_T) =>
      _$Recogkey_activateJsonFileFromJson(json_T);

  Map<String, dynamic> toJson() => _$Recogkey_activateJsonFileToJson(this);

  String jsonFileToJson(){
    return jsonEncode(_$Recogkey_activateJsonFileToJson(this));
  }
...
class _Server {
  ...
  String host;
  @JsonKey(defaultValue: "/api/v1/activate")
  String url;
...
class _Common {
  ...
  _Common({
    ...
    required this.chg_flg,
  });

  @JsonKey(defaultValue: 10)
  int    limit;
  @JsonKey(defaultValue: "00:07:32:18:31:D5")
  String mac_addr;
