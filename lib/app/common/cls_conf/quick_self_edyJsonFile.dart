...
part 'quick_self_edyJsonFile.g.dart';

@JsonSerializable(explicitToJson:true)
class Quick_self_edyJsonFile extends ConfigJsonFile {
  static final Quick_self_edyJsonFile _instance = Quick_self_edyJsonFile._internal();

  final String _confPath = "conf/";
  final String _fileName = "quick_self_edy.json";

  Quick_self_edyJsonFile(){
    setPath(_confPath, _fileName);
  }
  Quick_self_edyJsonFile._internal();

  factory Quick_self_edyJsonFile.fromJson(Map<String, dynamic> json_T) =>
      _$Quick_self_edyJsonFileFromJson(json_T);

  Map<String, dynamic> toJson() => _$Quick_self_edyJsonFileToJson(this);

  String jsonFileToJson(){
    return jsonEncode(_$Quick_self_edyJsonFileToJson(this));
  }
...
class _Screen0 {
  ...
  String title;
  @JsonKey(defaultValue: "Edyカード、Edyケータイを置いてから　　　「買い物スタート」ボタンを押してください。")
  String msg1;
...
class _Screen1 {
  ...
  @JsonKey(defaultValue: "スタート画面２（ボタンを押したが、Edyカードを検知できない）")
  String title;
  @JsonKey(defaultValue: "")
  String msg1;
  @JsonKey(defaultValue: "")
...
class _Screen2 {
  ...
  String title;
  @JsonKey(defaultValue: "＊残高以上のお買い物はできません　　＊複数枚でのご利用はできません")
  String msg1;
  @JsonKey(defaultValue: "Edy残高")
  String msg2;
  @JsonKey(defaultValue: 1)
  int    msg1_size;
...
class _Screen4 {
  ...
  @JsonKey(defaultValue: "残高不足取消画面")
  String title;
  @JsonKey(defaultValue: "残高不足です")
  String msg1;
...
class _Screen6 {
  ...
  @JsonKey(defaultValue: "残高表示＆レシート発行画面")
  String title;
  @JsonKey(defaultValue: "ありがとうございます　　　　　　　　　　　　Ｅｄｙのお取り忘れにご注意ください")
  String msg1;
  @JsonKey(defaultValue: "Ｅｄｙのお取り忘れにご注意ください　　　　　レシートが必要な方は店員をお呼びください")
  String msg2;
  @JsonKey(defaultValue: 2)
  int    msg1_size;
  @JsonKey(defaultValue: 2)
...
class _Screen7 {
  ...
  @JsonKey(defaultValue: "レシート発行後、Edy検知画面")
  String title;
  @JsonKey(defaultValue: "")
  String msg1;
  @JsonKey(defaultValue: "")
...
class _Screen14 {
  ...
  @JsonKey(defaultValue: "取消画面後、Edy検知画面")
  String title;
  @JsonKey(defaultValue: "")
  String msg1;
  @JsonKey(defaultValue: "")
...
class _Screen15 {
  ...
  @JsonKey(defaultValue: "ポイントカード画面")
  String title;
  @JsonKey(defaultValue: "")
  String msg1;
  @JsonKey(defaultValue: "")
...
class _Screen36 {
  ...
  @JsonKey(defaultValue: "Edyタッチ画面 　　　　　 (user_cd29に8が有効)")
  String title;
  @JsonKey(defaultValue: "")
  String msg1;
  @JsonKey(defaultValue: "")
...
class _Screen37 {
  ...
  String title;
  @JsonKey(defaultValue: "チャージ上限額を超えています　　　　　　　Ｅｄｙでのお取り扱いはできません")
  String msg1;
  @JsonKey(defaultValue: "Edy上限額")
  String msg2;
  @JsonKey(defaultValue: 1)
  int    msg1_size;
  @JsonKey(defaultValue: 3)
