...
part of 'orcJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

OrcJsonFile _$OrcJsonFileFromJson(Map<String, dynamic> json) => OrcJsonFile()
  ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$OrcJsonFileToJson(OrcJsonFile instance) =>
    <String, dynamic>{
