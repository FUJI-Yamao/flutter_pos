...
part 'meckey_2800imJsonFile.g.dart';

@JsonSerializable(explicitToJson:true)
class Meckey_2800imJsonFile extends ConfigJsonFile {
  static final Meckey_2800imJsonFile _instance = Meckey_2800imJsonFile._internal();

  final String _confPath = "conf/";
  final String _fileName = "meckey_2800im.json";

  Meckey_2800imJsonFile(){
    setPath(_confPath, _fileName);
  }
  Meckey_2800imJsonFile._internal();

  factory Meckey_2800imJsonFile.fromJson(Map<String, dynamic> json_T) =>
      _$Meckey_2800imJsonFileFromJson(json_T);

  Map<String, dynamic> toJson() => _$Meckey_2800imJsonFileToJson(this);

  String jsonFileToJson(){
    return jsonEncode(_$Meckey_2800imJsonFileToJson(this));
  }
...
class _Meckey1 {
  ...
  String key0;
  @JsonKey(defaultValue: "0x0506")
  String key1;
  @JsonKey(defaultValue: "0x0606")
  String key2;
  @JsonKey(defaultValue: "0x0706")
  String key3;
  @JsonKey(defaultValue: "0x0505")
  String key4;
  @JsonKey(defaultValue: "0x0605")
  String key5;
  @JsonKey(defaultValue: "0x0705")
  String key6;
  @JsonKey(defaultValue: "0x0504")
  String key7;
  @JsonKey(defaultValue: "0x0604")
  String key8;
  @JsonKey(defaultValue: "0x0704")
  String key9;
  @JsonKey(defaultValue: "0x0707")
  String key00;
  @JsonKey(defaultValue: "")
  String key000;
  @JsonKey(defaultValue: "0x1107")
  String RET;
  @JsonKey(defaultValue: "0x0503")
  String CLS;
  @JsonKey(defaultValue: "")
  String FEED;
  @JsonKey(defaultValue: "0x0906")
  String PLU;
  @JsonKey(defaultValue: "0x0907")
  String STL;
}
