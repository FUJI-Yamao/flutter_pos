...
part of 'tprtssJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TprtssJsonFile _$TprtssJsonFileFromJson(Map<String, dynamic> json) =>
    TprtssJsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$TprtssJsonFileToJson(TprtssJsonFile instance) =>
    <String, dynamic>{
...
_Settings _$SettingsFromJson(Map<String, dynamic> json) => _Settings(
      ...
      drw_on_time: json['drw_on_time'] as int? ?? 50,
