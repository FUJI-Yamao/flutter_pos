...
part of 'scan_2800_2JsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Scan_2800_2JsonFile _$Scan_2800_2JsonFileFromJson(Map<String, dynamic> json) =>
    Scan_2800_2JsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$Scan_2800_2JsonFileToJson(
        Scan_2800_2JsonFile instance) =>
    <String, dynamic>{
...
_Settings _$SettingsFromJson(Map<String, dynamic> json) => _Settings(
      ...
      id: json['id'] as int? ?? 2,
      port_type: json['port_type'] as String? ?? 'usb',
    );
