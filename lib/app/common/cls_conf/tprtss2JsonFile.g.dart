...
part of 'tprtss2JsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Tprtss2JsonFile _$Tprtss2JsonFileFromJson(Map<String, dynamic> json) =>
    Tprtss2JsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$Tprtss2JsonFileToJson(Tprtss2JsonFile instance) =>
    <String, dynamic>{
