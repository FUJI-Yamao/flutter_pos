...
part of 'mcp200JsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Mcp200JsonFile _$Mcp200JsonFileFromJson(Map<String, dynamic> json) =>
    Mcp200JsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$Mcp200JsonFileToJson(Mcp200JsonFile instance) =>
    <String, dynamic>{
