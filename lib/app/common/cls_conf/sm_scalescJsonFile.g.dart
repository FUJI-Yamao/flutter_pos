...
part of 'sm_scalescJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Sm_scalescJsonFile _$Sm_scalescJsonFileFromJson(Map<String, dynamic> json) =>
    Sm_scalescJsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$Sm_scalescJsonFileToJson(Sm_scalescJsonFile instance) =>
    <String, dynamic>{
