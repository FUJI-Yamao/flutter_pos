...
part of 'scan_plus_2JsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Scan_plus_2JsonFile _$Scan_plus_2JsonFileFromJson(Map<String, dynamic> json) =>
    Scan_plus_2JsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$Scan_plus_2JsonFileToJson(
        Scan_plus_2JsonFile instance) =>
    <String, dynamic>{
