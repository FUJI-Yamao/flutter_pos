...
part of 'scan_plus_1JsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Scan_plus_1JsonFile _$Scan_plus_1JsonFileFromJson(Map<String, dynamic> json) =>
    Scan_plus_1JsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$Scan_plus_1JsonFileToJson(
        Scan_plus_1JsonFile instance) =>
    <String, dynamic>{
