...
part of 'panaJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PanaJsonFile _$PanaJsonFileFromJson(Map<String, dynamic> json) => PanaJsonFile()
  ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$PanaJsonFileToJson(PanaJsonFile instance) =>
    <String, dynamic>{
