...
part of 'changerJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ChangerJsonFile _$ChangerJsonFileFromJson(Map<String, dynamic> json) =>
    ChangerJsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$ChangerJsonFileToJson(ChangerJsonFile instance) =>
    <String, dynamic>{
