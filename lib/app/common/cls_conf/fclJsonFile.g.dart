...
part of 'fclJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

FclJsonFile _$FclJsonFileFromJson(Map<String, dynamic> json) => FclJsonFile()
  ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$FclJsonFileToJson(FclJsonFile instance) =>
    <String, dynamic>{
