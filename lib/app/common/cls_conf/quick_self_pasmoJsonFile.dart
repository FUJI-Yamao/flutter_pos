...
part 'quick_self_pasmoJsonFile.g.dart';

@JsonSerializable(explicitToJson:true)
class Quick_self_pasmoJsonFile extends ConfigJsonFile {
  static final Quick_self_pasmoJsonFile _instance = Quick_self_pasmoJsonFile._internal();

  final String _confPath = "conf/";
  final String _fileName = "quick_self_pasmo.json";

  Quick_self_pasmoJsonFile(){
    setPath(_confPath, _fileName);
  }
  Quick_self_pasmoJsonFile._internal();

  factory Quick_self_pasmoJsonFile.fromJson(Map<String, dynamic> json_T) =>
      _$Quick_self_pasmoJsonFileFromJson(json_T);

  Map<String, dynamic> toJson() => _$Quick_self_pasmoJsonFileToJson(this);

  String jsonFileToJson(){
    return jsonEncode(_$Quick_self_pasmoJsonFileToJson(this));
  }
...
class _Screen0 {
  ...
  String title;
  @JsonKey(defaultValue: "「買い物スタート」ボタンを押してから　　　 ＰＡＳＭＯをタッチしてください。")
  String msg1;
...
class _Screen1 {
  ...
  @JsonKey(defaultValue: "スタート画面２（ボタンを押したが、ＰＡＳＭＯを検知できない）")
  String title;
  @JsonKey(defaultValue: "")
  String msg1;
  @JsonKey(defaultValue: "")
...
class _Screen5 {
  ...
  @JsonKey(defaultValue: "PASMOタッチ画面")
  String title;
...
class _Screen6 {
  ...
  String title;
  @JsonKey(defaultValue: "ありがとうございます　　　　　　　　　　　　ＰＡＳＭＯのお取り忘れにご注意ください")
  String msg1;
  @JsonKey(defaultValue: "ＰＡＳＭＯのお取り忘れにご注意ください　　　レシートが必要な方は店員をお呼びください")
  String msg2;
  @JsonKey(defaultValue: 2)
  int    msg1_size;
  @JsonKey(defaultValue: 2)
...
class _Screen36 {
  ...
  @JsonKey(defaultValue: "PASMOタッチ画面 　　　　　 (user_cd29に8が有効)")
  String title;
  @JsonKey(defaultValue: "")
  String msg1;
  @JsonKey(defaultValue: "")
...
class _Screen37 {
  ...
  String title;
  @JsonKey(defaultValue: "チャージ上限額を超えています　　　　　　　ＰＡＳＭＯでのお取り扱いはできません")
  String msg1;
  @JsonKey(defaultValue: "PASMO上限額")
  String msg2;
  @JsonKey(defaultValue: 1)
  int    msg1_size;
  @JsonKey(defaultValue: 3)
