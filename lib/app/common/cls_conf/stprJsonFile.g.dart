...
part of 'stprJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

StprJsonFile _$StprJsonFileFromJson(Map<String, dynamic> json) => StprJsonFile()
  ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$StprJsonFileToJson(StprJsonFile instance) =>
    <String, dynamic>{
