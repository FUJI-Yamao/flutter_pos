...
part of 'tprtfJsonFile.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TprtfJsonFile _$TprtfJsonFileFromJson(Map<String, dynamic> json) =>
    TprtfJsonFile()
      ..settings = _Settings.fromJson(json['settings'] as Map<String, dynamic>);

Map<String, dynamic> _$TprtfJsonFileToJson(TprtfJsonFile instance) =>
    <String, dynamic>{
